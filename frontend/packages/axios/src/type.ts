...
export interface RequestOption<ResponseData = any> {
   ...
   * @param config The original request, used to reject responses from an outdated login session
   */
  onTokenRefresh?: (newToken: string, config: InternalAxiosRequestConfig) => void | Promise<void>;
}
