...
func (h *UserHandler) GetProfile(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{"code": http.StatusOK, "data": ProfileResponse{
		ID: user.ID, Username: user.Username, Role: user.Role, OrgTags: user.OrgTags,
		PrimaryOrg: user.PrimaryOrg, CreatedAt: user.CreatedAt, UpdatedAt: user.UpdatedAt,
	}, "message": "success"})
}
...
func (h *UserHandler) Logout(c *gin.Context) {
	...
	err := h.userService.Logout(tokenString, c.GetHeader("X-Refresh-Token"))
	if err != nil {
