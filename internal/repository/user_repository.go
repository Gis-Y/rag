...
type UserRepository interface {
	...
	CreateWithPrivateTag(user *model.User, tag *model.OrganizationTag) error
...
// CreateWithPrivateTag keeps registration all-or-nothing and rejects tag collisions.
func (r *userRepository) CreateWithPrivateTag(user *model.User, tag *model.OrganizationTag) error {
